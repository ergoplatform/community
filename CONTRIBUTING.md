...
If you find a vulnerability that may affect live deployments -- for example, 
...
<!--The GPG key for security@ipfs.io is [4B9665FB 92636D17 7C7A86D3 50AAE8A9 59B13AF3](https://pgp.mit.edu/pks/lookup?op=get&search=0x50AAE8A959B13AF3).-->
...
<!--TODO https://github.com/ergoplatform/community/issues/2 -->
<!--The [ergo](https://github.com/ergoplatform/ergo) issues use a template that will guide you -->
<!--through the process of reporting a bug. We will be adding this kind of issue template to other -->
<!--repositories as bug reports become more common.-->
...
## Translations
<!--TODO https://github.com/ergoplatform/community/issues/4-->
...
<!--TODO https://github.com/ergoplatform/community/issues/5, check out [the job listings](http://protocol.ai/join)-->
...
<!--TODO https://github.com/ergoplatform/community/issues/6 (Developers Channel)-->
...
<!--TODO https://github.com/ergoplatform/community/issues/7 -->
...
<!--
Once enabled GitCop checks for two possible problems that are described below.
...
Please make sure that fixup commits are squashed into other related
